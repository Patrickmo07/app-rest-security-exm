...
import pe.edu.cibertec.app_rest_security_exm.dto.UsuarioResponseDto;
...
import pe.edu.cibertec.app_rest_security_exm.service.impl.DetalleUsuarioService;
    ...
    )
    {
        try{
            ...
            if(authentication.isAuthenticated()){
                ...
                return new ResponseEntity<>(UsuarioResponseDto.builder().idusuario(objUsuario.getIdusuario())
